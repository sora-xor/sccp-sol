#!/usr/bin/env python3
"""
Encode a bridge-relayer SCCP mint-proof JSON into Solana verifier Borsh bytes.

Input is expected to come from:
  bridge-relayer ... sccp evm mint-proof ...
...
def main():
    parser = argparse.ArgumentParser(description="Encode SCCP Solana burn proof (Borsh) from bridge-relayer JSON")
    parser.add_argument("--input", required=True, help="Path to bridge-relayer mint-proof JSON")
